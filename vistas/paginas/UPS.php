...
<link rel="stylesheet" href="./assets/css/style_UPS.css">
<div class="d-flex justify-content-center">
  <section class="form-login">
    <h5>Registro de UPS</h5>
    <form method="POST">


    <label>Datos del UPS*</label></br>
...
include_once './modelos/conexion2.php';
  ...
  <input class="controls" type="text" id="Nom_Cap" name="registroCap" placeholder="Capacidad: Volts"class="input-48" required>
...
include_once './modelos/conexion2.php';
     ...
     <div id="contact-form">      
      ...
      <select class="controls" type="text" id="marca" name="registroEstado" placeholder="Seleccione un Estado"class="input-48" required>
            <?php 
                $con=conexion();
                #Seleccionar Estado
      ...
      $registro = ControladorUPS::ctrRegistro();
