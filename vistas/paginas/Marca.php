...
<div class="d-flex justify-content-center">
  <section class="form-login">
    ...
    <form method="POST">
      <label>Datos de la Marca*</label></br>

      <input class="controls" type="text" id="Nom_Marca" name="Nom_Marca" placeholder="Nombre de la Marca"
      ...
      $registro = ControladorMarca::ctrRegistro();
