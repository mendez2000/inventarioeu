...
<div class="d-flex justify-content-center">
  <section class="form-login">
    <h5>Registro de Accesorios</h5>
    <form method="POST">


    <label>Datos del Accesorio*</label></br>
...
include_once './modelos/conexion2.php';
  ...
  <tr>
    ...
    <input type="text" class="form-control" id="Nom_Ser" name="registroSerie" placeholder="Ingrese Serie"class="input-48" required>
      ...
      <input class="controls" type="text" id="Nom_Tipo" name="registroTipo" placeholder="Descripcion"class="input-48" required>
...
include_once './modelos/conexion2.php';
     ...
     <div id="contact-form">      
      ...
      $registro = ControladorAccesorios::ctrRegistro();
