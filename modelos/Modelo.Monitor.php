...
class ModeloMonitor
{
	...
	static public function mdlRegistro($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(inv, id_marca, modelo, serie, tipo, tam, id_est) VALUES (:inv, :id_marca, :serie, :modelo, :tipo, :tam, :id_est)");
		...
		$stmt->bindParam(":tam", $datos["tam"], PDO::PARAM_STR);
